...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autorization = __webpack_require__(1);
	
	//var transl = require('./transactionlist');
	
	exports.default = {
	  //addt: addt,
	  authRender: _autorization.authRender
	  //transl: transl
	}; /* 
	...
	//var addt = require('./addtransaction');
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.console.debug(React);
	window.console.debug(ReactDOM);
	
	var login = function login() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? { 'login': false } : arguments[0];
	...
	var store = (0, _redux.createStore)(login);
	...
	function authRender() {
	    ...
	    //       
	    //    }
	    var LoginPage = function LoginPage(_ref, e) {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'form',
	                    { method: 'post', onClick: x },
	                    React.createElement(
	                        'p',
	                        null,
	                        React.createElement('input', { type: 'text', name: 'login', placeholder: 'Username or Email' })
	                    ),
	                    React.createElement(
	                        'p',
	                        null,
	                    ...
	                    React.createElement(
	                        'p',
	                        { className: 'submit' },
	                        React.createElement('input', (0, _defineProperty3.default)({ type: 'submit', value: 'Post', name: 'commit' }, 'value', 'Login'))
	                    )
	                )
	            )
	        );
	    ...
	    var FirstPage = function FirstPage(_ref2) {
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'p',
	                        null,
	                        React.createElement('input', { type: 'password', name: 'password', placeholder: 'bla bla bla' })
	                    ),
	                    React.createElement(
	                        'p',
	                        { className: 'submit' },
	    ...
	    var render = function render() {
	        ...
	        if (store.getState().login === false) {
	            ReactDOM.render(React.createElement(LoginPage, { onLogin: function onLogin() {
	                    store.dispatch({ type: 'LOGIN' });
	                } }), document.getElementById('react_content'));
	        } else {
	            ReactDOM.render(React.createElement(FirstPage, { onLogin: function onLogin() {
